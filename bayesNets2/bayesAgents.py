...
class VPIAgent(BayesAgent):
    ...
    def computeEnterValues(self, evidence, eliminationOrder):
        ...
        *Do not* take into account the "time elapsed" cost of traveling to each
        ...
        leftExpectedValue = CPT.getProbability(left) * WON_GAME_REWARD + CPT.getProbability(right) * GHOST_COLLISION_REWARD 
        rightExpectedValue = CPT.getProbability(left) * GHOST_COLLISION_REWARD + CPT.getProbability(right) * WON_GAME_REWARD
